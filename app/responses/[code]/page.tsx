...
const ResponsesPage = ({ params }: { params: { code: string } }) => {
  ...
  return (
    <main className="bg-[#141416] h-screen w-screen overflow-auto flex flex-col main-scrollbar-hide">
      <Navber />
      <div className="grid grid-cols-1 md:grid-cols-8 gap-4 my-6 mx-4 sm:mx-6 md:mx-8 lg:mx-12 flex-grow overflow-auto main-scrollbar-hide">
        <div className="hidden md:col-span-2 p-6 dashboard-bg rounded-xl shadow-xl md:flex flex-col items-center overflow-auto main-scrollbar-hide">
        ...
        <div className="md:col-span-6 p-6 dashboard-bg rounded-xl shadow-xl overflow-scroll main-scrollbar-hide">
          <div className="flex gap-4 mb-6 mt-2">
            ...
            <div className="flex-grow bg-[#180721] text-white px-6 py-4 rounded-xl shadow-xl">
              <p className="text-yellow-300 tracking-wider font-semibold text-md mb-2">
                DETAILS
              </p>
              <span className="italic tracking-wide">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Id
                aspernatur laboriosam culpa nulla perferendis accusantium dicta
                adipisci in amet, porro corporis illo sequi ipsa ex quisquam
                voluptates cupiditate officia architecto!
              </span>
            </div>
          </div>
