...
const Dashboard = () => {
  ...
  return (
    <main className="bg-[#F1F2F4] h-screen w-screen overflow-auto flex flex-col main-scrollbar-hide">
      <Navber />
      <div className="my-6 mx-4 sm:mx-6 md:mx-8 lg:mx-12 p-6 dashboard-bg rounded-xl shadow-xl flex-grow flex flex-col">
        <div className="flex justify-between px-6 mt-2">
          <h1 className="text-left text-white text-xl font-bold tracking-wide">
            Your Questioniers
          </h1>
          <button className="text-slate-900 font-bold text-lg bg-slate-300 px-6 py-2.5 rounded-xl shadow-lg hover:bg-slate-900 hover:text-slate-200">
            CREATE
          </button>
        </div>
